...
class LGBClassifier(BaseClassifier):
	def __init__(self,
	             boosting_type="gbdt",
	             num_leaves=1024,
	             max_depth=-1,
	             ...
	             e_id=None,
	             **kwargs):
		super(LGBClassifier, self).__init__(e_id=e_id, random_state=random_state, **kwargs)
		...
		self.model_name = 'LGBClassifier'
		self.model = lgb.sklearn.LGBMClassifier(boosting_type=self.boosting_type,
