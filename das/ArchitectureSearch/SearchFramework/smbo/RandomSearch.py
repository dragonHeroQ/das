...
class RandomSearch(SMBO):
	...
	def __init__(self,
		...
		super(RandomSearch, self).__init__(optimizer_class=RandomSearchOptimizer,
...
if __name__ == '__main__':
	...
	RS = RandomSearch(evaluator=evaluator, learning_tool=learning_tool,
	                  total_budget=1, budget_type='trial',
