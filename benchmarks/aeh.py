...
from das.BaseAlgorithm.algorithm_space import get_all_classification_algorithm_keys
...
AE.fit(1, 1, confidence_screening=True, debug=is_debugging, distribute=0)
