...
hbc1 = HorizontalBlockClassifier(4, RandomForestClassifier,
                                 model_params={'n_estimators': 100, 'max_depth': 100})
hbc2 = HorizontalBlockClassifier(4, ExtraTreesClassifier,
                                 model_params={'n_estimators': 100, 'max_depth': 100, 'max_features': 1})
alc = ArchiLayerClassifier(2, [("RF", hbc1), ("ERF", hbc2)], e_id=0, random_state=rng)
