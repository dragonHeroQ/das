...
from das.ArchitectureSearch.LearningTool.CompModelLearningTool import CompModelLearningTool
...
learning_tool = CompModelLearningTool(n_block=2, n_classes=n_classes, evaluation_rule=evaluation_rule)
...
AE.fit(x_train, y_train, confidence_screening=True, debug=is_debugging)
