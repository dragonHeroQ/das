...
from automl.BaseAlgorithm.classification.SKLearnBaseAlgorithm import SVM, GBDT
...
for i in range(1):
    ...
    clf = Classifier(total_timebudget=300, per_run_timebudget=10,
                     ...
                     validation_strategy="cv", validation_strategy_args=3, budget_type="time",
