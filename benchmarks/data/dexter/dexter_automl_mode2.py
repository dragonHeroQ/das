...
for i in range(1):
    ...
    clf = Classifier(total_timebudget=1*60, per_run_timebudget=60, ensemble_size=25, predict_method="predict",
                     validation_strategy="holdout", validation_strategy_args=0.33, random_state=1, log_level='DEBUG')
    clf.set_version(i)
    ...
    tmp_res = eval_performance("top_1_accuracy", y_true=y_test, y_score=y_hat)
