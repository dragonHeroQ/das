...
for i in range(10):
    ...
    # rgr = Regressor_new(q_epsilon=0.7, total_timebudget=60*60, per_run_timebudget=60,
    #                  validation_strategy="cv", validation_strategy_args=3)

    rgr = Regressor(q_epsilon=0.5, total_timebudget=60 * 60, per_run_timebudget=60,
    ...
    try:
        ...
        logger.info("automl_mode_2 on cpusmall: {}".format(tmp_res))
