...
for i in range(10):
    ...
    rgr = Regressor(q_epsilon=0.7, total_timebudget=60 * 60, per_run_timebudget=60, ensemble_size=25,
    ...
    try:
        ...
        logger.info("automl_mode_2 on mg: {}".format(tmp_res))
